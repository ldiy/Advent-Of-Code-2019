...
for($pos =0; $pos < $len; $pos = $pos){
	...
	elseif($opcode == 3){
		$input[$P1] = $userInput;
		echo "input given.." .$userInput. PHP_EOL;
		$pos += 2;
	}
	/* output */
	elseif($opcode == 4){
